...
// File Directory: /open-platform/search/index.php
...
$result = mysqli_query($conn, "SELECT * FROM public_table_list WHERE table_name LIKE '%$query%'");
			...
			<div class="container">
				<div id="row">
					...
					foreach ($result as $row) {
						...
						echo('
						<div id="query-admin-user"> Created by ');
							echo(htmlspecialchars($row['admin_user']));
						echo('</div></div></a>');
					}
					echo('
				</div>
